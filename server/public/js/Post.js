$(document).ready(function(){
    ...
    // Question
    $("[name='Question']").popover({trigger: 'focus', content: "" ,placement : 'top'});
    ...
    $("[name='D']").focus(function(){
        if($("#D").hasClass("has-error"))
        $(this).popover('show'); 
    });

    // Explanation
    $("[name='Explanation']").popover({trigger: 'focus', content: "" ,placement : 'top'});
